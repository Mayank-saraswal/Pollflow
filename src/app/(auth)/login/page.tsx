    ...
    <div className="min-h-screen flex items-center justify-center px-4 dot-pattern">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass-card rounded-2xl gradient-border p-8">
          <h1 className="text-2xl font-display font-semibold text-white mb-2 text-center">Welcome back</h1>
          <p className="text-white/50 text-sm font-body text-center mb-8">
